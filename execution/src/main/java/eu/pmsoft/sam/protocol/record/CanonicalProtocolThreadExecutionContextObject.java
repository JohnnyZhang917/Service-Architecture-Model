...
class CanonicalProtocolThreadExecutionContextObject implements CanonicalProtocolThreadExecutionContext {
    ...
    @Inject
    public CanonicalProtocolThreadExecutionContextObject(@Assisted("record") MethodRecordContext recordStack, @Assisted("execute") MethodRecordContext executionStack,
