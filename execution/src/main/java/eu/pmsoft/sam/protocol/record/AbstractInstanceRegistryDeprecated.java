...
abstract class AbstractInstanceRegistryDeprecated implements InstanceRegistry, InstanceMergeVisitor {
    ...
    public AbstractInstanceRegistryDeprecated(int serviceSlotNr) {
