...
public class SamExecutionEnvironmentSimpleTest {
    ...
    public void testInfrastructureConfigurationSetup() {
        ...
        SamService serviceFromArchitecture = infrastructureApi.getArchitectureManager().getService(new ServiceKey(TestServiceOne.class));
        SamServiceImplementation serviceImplementation = infrastructureApi.getServiceRegistry().getImplementation(SamServiceImplementationKey.definedBy(TestServiceZeroModule.class));
