...
public class ServiceImplementationKey {
	...
	public ServiceImplementationKey(String serviceSpecificationSignature, String serviceImplementationSignature) {
		super();
	...
	public ServiceImplementationKey(Class<? extends SamServiceDefinition> serviceSpecificationSignature, Class<? extends Module> serviceImplementationSignature) {
		super();
		this.serviceSpecificationSignature = serviceSpecificationSignature.getCanonicalName();
		this.serviceImplementationSignature = serviceImplementationSignature.getCanonicalName();
	}
	@Override
	public int hashCode() {
		final int prime = 31;
		int result = 1;
		result = prime * result + ((serviceImplementationSignature == null) ? 0 : serviceImplementationSignature.hashCode());
		result = prime * result + ((serviceSpecificationSignature == null) ? 0 : serviceSpecificationSignature.hashCode());
		return result;
	}
	@Override
	public boolean equals(Object obj) {
		...
		if (serviceImplementationSignature == null) {
			if (other.serviceImplementationSignature != null)
				return false;
		} else if (!serviceImplementationSignature.equals(other.serviceImplementationSignature))
			return false;
		if (serviceSpecificationSignature == null) {
			if (other.serviceSpecificationSignature != null)
				return false;
		} else if (!serviceSpecificationSignature.equals(other.serviceSpecificationSignature))
			return false;
		return true;
	}
	@Override
